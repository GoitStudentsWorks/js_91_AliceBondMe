import{s as g,a as p,o as w}from"./modal-rating-23daee0c.js";function h(t){return t.map(({_id:e,bodyPart:o,name:a,target:l,burnedCalories:d})=>`<li class="favorites-rating_item js-workout-card" data-id="${e}">
